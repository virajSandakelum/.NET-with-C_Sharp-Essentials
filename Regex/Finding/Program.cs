...
Regex CapWord = new Regex(@"[A-Z]\w+");
Console.WriteLine(CapWord.IsMatch(teststr1));
Console.WriteLine(CapWord.IsMatch(teststr2));
...
Match m = CapWord.Match(teststr1);
while(m.Success){
...
MatchCollection mc = CapWord.Matches(teststr1);
